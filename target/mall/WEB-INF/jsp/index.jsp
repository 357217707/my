...
<%@ include file="/WEB-INF/jsp/include/head.jsp" %>
    ...
    <div class="style-banner">
    	<a href="#"><img src="/static/images/banner-tu.gif" /></a>
    </div>
    ...
    <div class="beaut-lg w1200">
    	<ul>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu1.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu1.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu3.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu2.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu3.gif" /></a></li>
        	<li style="width:155px; border-right:0;"><a href="#"><img src="/static/images/beaut-lg-tu2.gif" /></a></li>
        	...
        	<li><a href="#"><img src="/static/images/beaut-lg-tu1.gif" /></a></li>
        	<li><a href="#"><img src="/static/images/beaut-lg-tu2.gif" /></a></li>
        	<li style="width:155px; border-right:0;"><a href="#"><img src="/static/images/beaut-lg-tu3.gif" /></a></li>
    	...
    	<div class="sp-con-info">
        	<ul class="sp-info-r m-act beaut">
                <c:forEach items="${list}" var="product">
                    <li>
                        <div class="li-top">
                            <a href="/product/detail/${product.id}" class="li-top-tu"><img src="/static/images/beaut-con-li-tu2.gif" /></a>
                            <p class="jiage"><span class="sp1">￥${product.price}</span><span class="sp2">￥${product.price+100}</span></p>
                        </div>
                        <p class="miaoshu">${product.name}</p>
                        <div class="li-md">
                            <div class="md-l f-l">
                        ...
                        <p class="pingjia" name="pingjia" sign="${product.id}">0条评价</p>
